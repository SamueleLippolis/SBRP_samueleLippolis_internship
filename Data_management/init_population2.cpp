...
int main() {
   ...
   addNodesUsingProbabilityAndFindOptimal(
    ...
    std::cout << "\nFitness of 1-rs Route : " << calculateRouteFitness(routes[0], problemInstance.getDistancesMatrix()) << std::endl;

    std::cout << "\nFitness of 2-nd Route : " << calculateRouteFitness(routes[1], problemInstance.getDistancesMatrix()) << std::endl;

    std::cout << "\nTotal Fitness of all Routes: " << calculateRoutesFitness(routes, problemInstance.getDistancesMatrix()) << std::endl;
